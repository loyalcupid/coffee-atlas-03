...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen cafe-bg flex flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="sign-frame rounded-2xl p-8 space-y-5">
          ...
          <form onSubmit={handleEmail} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#FCF5E5]/50 uppercase tracking-widest flex items-center gap-1.5">
                <Mail size={12} /> 이메일 <span className="text-red-400">*</span>
              </label>
              <input
                type="email"
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#FCF5E5]/50 uppercase tracking-widest flex items-center gap-1.5">
                <Lock size={12} /> 비밀번호 <span className="text-red-400">*</span>
              </label>
              <input
                type="password"
                placeholder="6자 이상"
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#FCF5E5]/50 uppercase tracking-widest flex items-center gap-1.5">
                <Lock size={12} /> 비밀번호 확인 <span className="text-red-400">*</span>
              </label>
              <input
                type="password"
            ...
            >
              <UserPlus size={16} /> {loading ? "가입 중..." : "회원가입"}
            </button>
          </form>

          <p className="text-center cormorant text-[#FCF5E5]/35 text-base">
            이미 계정이 있으신가요?{" "}
            <Link href="/login" className="text-[#D4AF37]/70 hover:text-[#D4AF37] transition-colors font-semibold">
              로그인
            </Link>
          </p>
        </div>
